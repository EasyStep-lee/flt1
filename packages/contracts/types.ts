...
export interface components {
    schemas: {
        ...
        CategoryTemplateCreateRequestDto: {
             ...
             * @enum {string}
             */
            profile: "FOOD" | "FRESH" | "APPAREL" | "GENERIC";
        ...
        PublicFoodProductDetailResponseDto: {
            ...
            supplierId: string;
            /** @enum {string} */
            templateProfile: "FOOD" | "FRESH" | "APPAREL";
            templateVersion: number;
        };
