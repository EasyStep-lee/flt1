...
export interface components {
    schemas: {
        ...
        CategoryTemplateCreateRequestDto: {
             ...
             * @enum {string}
             */
            profile: "FOOD" | "FRESH" | "APPAREL" | "DIGITAL" | "GENERIC";
        ...
        PublicFoodProductDetailResponseDto: {
            ...
            supplierId: string;
            /** @enum {string} */
            templateProfile: "FOOD" | "FRESH" | "APPAREL" | "DIGITAL";
            templateVersion: number;
        };
