export interface paths {
    ...
    "/v1/consumer/orders/{orderId}/welfare-card-full-payment": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put?: never;
        /** Pay an owned consumer order fully with one eligible welfare-card account */
        post: operations["consumerWelfareCard.payFullOrder"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/consumer/orders/{orderId}/welfare-card-wechat-payment": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put?: never;
        /** Freeze the automatic welfare deduction and create one WeChat prepay for the difference */
        post: operations["payments.createWelfareCardWechatPayment"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/consumer/welfare-card-accounts/bind": {
        ...
        get?: never;
        put?: never;
        /** Bind one issued welfare-card code to the verified consumer */
        post: operations["consumerWelfareCard.bindAccount"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        WelfareCardFullPaymentRequestDto: {
            /** Format: uuid */
            accountId: string;
        };
        WelfareCardFullPaymentResponseDto: {
            /**
             * @description External payable amount; always zero for this endpoint
             * @enum {number}
             */
            cashAmount: 0;
            itemCount: number;
        ...
        WelfareCardWechatPaymentResponseDto: {
            /** @description WeChat amount in integer cents */
            amount: number;
            /** @description WeChat difference in integer cents */
            cashAmount: number;
            /** @enum {string} */
            channel: "WECHAT_PAY";
            /** @enum {string} */
            ...
            /** @enum {string} */
            status: "PREPAY_CREATED";
            /** @description Server-owned order total in integer cents */
            totalAmount: number;
            /** @description Frozen welfare-card amount in integer cents */
            welfareCardAmount: number;
        };
...
export interface operations {
    ...
    "consumerWelfareCard.payFullOrder": {
        parameters: {
            query?: never;
            header: {
                "Idempotency-Key": string;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["WelfareCardFullPaymentRequestDto"];
            };
        };
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["WelfareCardFullPaymentResponseDto"];
                };
            };
            201: {
                headers: {
    ...
    "payments.createWelfareCardWechatPayment": {
        parameters: {
            query?: never;
            header: {
                "Idempotency-Key": string;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["WelfareCardWechatPaymentRequestDto"];
            };
        };
        responses: {
    ...
    "consumerWelfareCard.bindAccount": {
        parameters: {
            query?: never;
            header: {
                "Idempotency-Key": string;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["WelfareCardBindRequestDto"];
            };
        };
        responses: {
            /** @description Exact idempotent replay */
