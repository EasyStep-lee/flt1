...
test('M3-P020 ledgers and generated contract preserve the personal-only home boundary', () => {
  ...
  assert.match(taskLedger, /M3-P053[^\r\n]+DONE,CI_PASS/u);
  assert.match(taskLedger, /M3-P054[^\r\n]+DONE,CI_PASS/u);
  assert.match(taskLedger, /M3-P055[^\r\n]+DONE,CI_PASS/u);
  assert.match(taskLedger, /M3-P056[^\r\n]+DONE,CI_PASS/u);
  assert.match(taskLedger, /M3-P057[^\r\n]+DONE,CI_PASS/u);
  assert.match(taskLedger, /M3-P058[^\r\n]+DONE,CI_PASS/u);
  assert.match(taskLedger, /M3-P059[^\r\n]+DONE,CI_PASS/u);
  assert.match(taskLedger, /M3-P062[^\r\n]+IN_PROGRESS,LOCAL_PASS/u);
