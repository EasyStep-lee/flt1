...
test('M2-P015 remains closed after later M2 slices advance', async () => {
  ...
  assert.equal(state.github.previousTaskDelivery.exactHead, 'd9b80f2aa3ac42175db59f73d2f21968326aee46');
  assert.equal(state.github.previousTaskDelivery.mergeCommit, 'f2b64fa64520db4d5daf051b1a58d3f295519331');
  assert.equal(state.github.previousTaskDelivery.mainPostMergeCiRun, 31756365765);
