...
test('M2-P015 remains closed after later M2 slices advance', async () => {
  ...
  assert.equal(state.github.previousTaskDelivery.exactHead, '78eeade32d868b32d544230d218a90ef9f259c01');
  assert.equal(state.github.previousTaskDelivery.mergeCommit, '05c87e058d86ab05dfaa09b6bb6d4341e7f45019');
  assert.equal(state.github.previousTaskDelivery.mainPostMergeCiRun, 31697763759);
