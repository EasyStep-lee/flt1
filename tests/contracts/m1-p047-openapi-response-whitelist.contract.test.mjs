...
test('M1-P047 evidence remains closed after PR 20 merge as the project advances', async () => {
  ...
  assert.equal(state.github.mergeCommitSha, '590a7708439afe40d4b2259fd346a9638bdbaf6f');
  ...
  assert.equal(state.github.previousTaskDelivery.taskId, 'M2-P008');
  assert.equal(state.github.previousTaskDelivery.pullRequest, 42);
