...
test('M3 money, order, inventory and privacy invariants are codeable and closed', async () => {
  ...
  assert.equal(fields.length, 322);
...
test('M3 client boundaries and negative behavior plans are explicit', async () => {
  ...
  const implementedSlices = new Set(['M3-P031', 'M3-P051', 'M3-P052', 'M3-P053', 'M3-P054', 'M3-P055', 'M3-P056', 'M3-P057', 'M3-P058', 'M3-P059', 'M3-P062', 'M3-P073', 'M3-P074', 'M3-P075']);
