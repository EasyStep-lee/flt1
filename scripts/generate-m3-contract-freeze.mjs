...
const enumFormats = {
  ...
  'WelfareCardProgram.fundingType': 'ENTERPRISE_GRANT|COMPANY_GIFT|PHYSICAL_CARD_OR_CODE', 'WelfareCardProgram.issuerType': 'COMPANY', 'WelfareCardProgram.scopeType': 'ALL_PRODUCTS|CATEGORY|PRODUCT|SKU',
