...
export const ENTERPRISE_ONBOARDING_ERROR_CODES = Object.freeze([
  'CREDIT_CODE_DUPLICATE',
  'ENTERPRISE_NOT_FOUND',
  'ENTERPRISE_NOT_ACTIVE',
  'ENTERPRISE_PROFILE_INCOMPLETE',
  'ENTERPRISE_SCOPE_FORBIDDEN',
] as const);
...
export const FULFILLMENT_ERROR_CODES = Object.freeze([
  'FULFILLMENT_HANDOVER_PARTY_INVALID',
] as const);
...
export const WELFARE_CARD_ERROR_CODES = Object.freeze([
  'DUPLICATE_OR_STATE_CONFLICT',
  'PERSONAL_RECHARGE_FORBIDDEN',
  'WELFARE_BATCH_AMOUNT_MISMATCH',
  'WELFARE_CLAIM_MODE_INVALID',
  'WELFARE_FUNDING_SOURCE_INVALID',
  'WELFARE_PROGRAM_NOT_FOUND',
] as const);
...
export const API_ERROR_CODES = Object.freeze([
  ...
  ...ENTERPRISE_ONBOARDING_ERROR_CODES,
  ...INVENTORY_ERROR_CODES,
  ...FULFILLMENT_ERROR_CODES,
  ...PAYMENT_ERROR_CODES,
  ...REFUND_ERROR_CODES,
  ...WELFARE_CARD_ERROR_CODES,
] as const);
