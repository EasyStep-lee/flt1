...
export const WELFARE_CARD_ERROR_CODES = Object.freeze([
  ...
  'WELFARE_CARD_INSUFFICIENT_BALANCE',
  'WELFARE_CARD_NOT_ELIGIBLE',
  'WELFARE_CARD_MIXED_PAYMENT_NOT_APPLICABLE',
  'WELFARE_ADJUSTMENT_NOT_FOUND',
  'WELFARE_ADJUSTMENT_STATE_INVALID',
  'WELFARE_ADJUSTMENT_VERSION_CONFLICT',
  'WELFARE_LEDGER_INCONSISTENT',
  'WELFARE_LEDGER_SCOPE_FORBIDDEN',
  'WELFARE_REVERSAL_INVALID',
