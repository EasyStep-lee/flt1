...
import { WelfareCardAdjustmentsPage } from './welfare-card-adjustments-page.js';
    ...
    return (
      <CompanyWorkspaceGate
        content={
          ...
          ) : currentPath === '/company-admin/workspaces/finance' ? (
            (workspace) => <WelfareCardAdjustmentsPage workspace={workspace} />
          ) : undefined
        }
        route={currentPath}
      />
