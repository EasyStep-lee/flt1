...
test('runner mini-program build produces an independent developer-tool root', () => {
  ...
  assert.match(appJavaScript, /fulishe:runner-miniapp/u);
  assert.match(pageJavaScript, /runner-miniapp-shell/u);
